...
${BACKUP_DIRS_DIR}etc/=30
${BACKUP_DIRS_DIR}root/=30
${BACKUP_DIRS_DIR}root.bin/=30
${BACKUP_DIRS_DIR}home.imap/=30
${BACKUP_DIRS_DIR}var.spool.mail/=30
${BACKUP_DIRS_DIR}home.httpd/=30
${BACKUP_DIRS_DIR}home.fleurbank.bin/=30"
